    ...
    <div className="h-1/6 w-full bg-fuchsia-950 flex flex-row justify-center items-center px-6 py-1">
      ...
      <div className="w-[65%] h-[80%] px-2 flex flex-col align-start justify-center">
        ...
        <div className="flex flex-row align-center mt-8">
          ...
          <p className="border-2 font rounded-full text-red-400 border-red-400 px-4 py-0 mx-1 ">
            IEEE Website
          </p>
          <p className="border-2 font rounded-full text-green-700 border-green-700 px-4 py-0 mx-1 ">
            PAD Website
          </p>
        </div>
      </div>
      <div className="w-[25%] h-[80%] flex flex-row justify-end mt-4">
        ...
        <p className="border-2 font rounded-full h-fit text-red-400 border-red-400 px-4 py-0 mx-1 ">
          IEEE Website
        </p>
      </div>
    </div>
